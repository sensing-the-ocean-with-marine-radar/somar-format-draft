...
- `product_name` is a short, snake_case name identifying the product, matching the naming used for the product throughout this document (e.g. `sea_surface_roughness`, `currents`, `currents_profile`, `bathymetry`, `sea_ice_drift`).
